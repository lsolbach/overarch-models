...
## Concepts
### [Alibaba Cloud](../../software-development/cloud/alibaba-cloud.md)
...
### [Amazon Web Services (AWS)](../../software-development/cloud/aws.md)
...
### [Azure](../../software-development/cloud/azure.md)
...
### [Broad network access](../../software-development/cloud/broad-network-access.md)
Capabilities are available over the network and accessed through standard
          mechanisms that promote use by heterogeneous thin or thick client platforms
          (e.g., mobile phones, tablets, laptops, and workstations).

### [Cloud Adoption Framework](../../software-development/cloud/cloud-adoption-framework.md)
...
### [Cloud Computing](../../software-development/cloud/cloud-computing.md)
...
### [Cloud Computing Platform](../../software-development/cloud/cloud-computing-platform.md)
...
### [Cloud Deployment Model](../../software-development/cloud/cloud-deployment-model.md)
Cloud deployment models include Public Cloud, Private Cloud, Hybrid Cloud, and
          Multi-Cloud.

### [Cloud Migration Assessment](../../software-development/cloud/cloud-migration-assessment.md)
...
### [Cloud Migration Execution](../../software-development/cloud/cloud-migration-execution.md)
...
### [Cloud Migration Optimization](../../software-development/cloud/cloud-migration-optimization.md)
...
### [Cloud Migration Plan](../../software-development/cloud/cloud-migration-plan.md)
...
### [Cloud Migration Strategy](../../software-development/cloud/cloud-migration-strategy.md)
...
### [Cloud Migration Validation](../../software-development/cloud/cloud-migration-validation.md)
...
### [Cloud Native Application](../../software-development/cloud/cloud-native-application.md)
...
### [Cloud Provider](../../software-development/cloud/cloud-provider.md)
...
### [Cloud Service Model](../../software-development/cloud/cloud-service-model.md)
The type of service provided by a cloud provider

### [Container as a Service (CaaS)](../../software-development/cloud/caas.md)
...
### [Infrastructure as a Service (IaaS)](../../software-development/cloud/iaas.md)
Provides virtualized network and computing resources over the internet

### [Landing Zone](../../software-development/cloud/landing-zone.md)
...
### [Measured service](../../software-development/cloud/measured-service.md)
...
### [Multi-Cloud](../../software-development/cloud/multi-cloud.md)
A cloud computing strategy that involves using multiple cloud services from different providers.

### [On Premises](../../software-development/cloud/on-premises.md)
...
### [On-demand self-service](../../software-development/cloud/on-demand-self-service.md)
...
### [Oracle Cloud](../../software-development/cloud/oracle-cloud.md)
A cloud computing platform and service created by Oracle. Oracle Cloud offers a wide
          range of cloud services, including virtual machines, databases, AI, machine learning, and IoT, as well
          as developer tools and services for building, deploying, and managing applications on the cloud.

### [Platform as a Service (PaaS)](../../software-development/cloud/paas.md)
...
### [Private Cloud](../../software-development/cloud/private-cloud.md)
...
### [Public Cloud](../../software-development/cloud/public-cloud.md)
...
### [Rapid elasticity](../../software-development/cloud/rapid-elasticity.md)
...
### [Rearchitect](../../software-development/cloud/rearchitect.md)
...
### [Rebuild](../../software-development/cloud/rebuild.md)
...
### [Refactor](../../software-development/cloud/refactor.md)
...
### [Rehost](../../software-development/cloud/rehost.md)
...
### [Relocate](../../software-development/cloud/relocate.md)
...
### [Replace](../../software-development/cloud/replace.md)
...
### [Replatform](../../software-development/cloud/replatform.md)
...
### [Repurchase](../../software-development/cloud/repurchase.md)
...
### [Resource pooling](../../software-development/cloud/resource-pooling.md)
The provider's computing resources are pooled to serve multiple consumers
          using a multi-tenant model, with different physical and virtual resources
          dynamically assigned and reassigned according to consumer demand.

### [Retain](../../software-development/cloud/retain.md)
...
### [Retire](../../software-development/cloud/retire.md)
...
### [Software as a Service (SaaS)](../../software-development/cloud/saas.md)
...
### [Tencent Cloud](../../software-development/cloud/tencent-cloud.md)
A cloud computing platform and service created by Tencent. Tencent Cloud offers a wide
          range of cloud services, including virtual machines, databases, AI, machine learning, and IoT, as well
          as developer tools and services for building, deploying, and managing applications on the cloud.

### [Well-Architected Framework](../../software-development/cloud/well-architected-framework.md)
