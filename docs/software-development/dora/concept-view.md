...
| [Climate for Learning](../../software-development/dora/capability/climate-for-learning.md)| A key predictor of software delivery performance |
| [Code maintainability](../../software-development/dora/capability/code-maintainability.md)| Make it easy for developers to find, reuse, and change code, and keep dependencies up-to-date. |
| [Commercial performance](../../software-development/dora/commercial-performance.md)|  |
| [Continouos delivery](../../software-development/dora/capability/continuous-delivery.md)| Make deploying software a reliable, low-risk process that can be performed on demand at any time. |
| [Continouos integration](../../software-development/dora/capability/continuous-integration.md)| Learn about common mistakes, ways to measure, and how to improve on your continuous integration efforts. |
| [Customer feedback](../../software-development/dora/capability/customer-feedback.md)| Drive better organizational outcomes by gathering customer feedback and incorporating it into product and feature design. |
| [Database change management](../../software-development/dora/capability/database-change-management.md)| Make sure database changes don't cause problems or slow you down. |
| [Deployment automation](../../software-development/dora/capability/deployment-automation.md)| Best practices and approaches for deployment automation and reducing manual intervention in the release process. |
...
| [Documentation quality](../../software-development/dora/capability/documentation-quality.md)| Maintain accurate, well-organized, user-centric internal documentation to empower teams throughout the software development process. |
| [Empowering teams to choose tools](../../software-development/dora/capability/empowering-teams-to-choose-tools.md)| Empower teams to make informed decisions on tools and technologies. Learn how these decisions drive more effective software delivery. |
| [Fast Feedback](../../software-development/dora/capability/fast-feedback.md)| A key predictor of software delivery performance. |
| [Fast Flow](../../software-development/dora/capability/fast-flow.md)| A key predictor of software delivery performance. |
| [Flexible infrastructure](../../software-development/dora/capability/flexible-infrastructure.md)| Find out how to manage cloud infrastructure effectively so you can achieve higher levels of agility, availability, and cost visibility. |
| [Generative organizational culture](../../software-development/dora/capability/generative-organizational-culture.md)| Discover how growing a generative, high-trust culture drives better organizational and software delivery performance. |
...
| [Job satisfaction](../../software-development/dora/capability/job-satisfaction.md)| Find out about the importance of ensuring your people have the tools and resources to do their job, and of making good use of their skills and abilities. |
| [Learning culture](../../software-development/dora/capability/learning-culture.md)| Grow a learning culture and understand its impact on your organizational performance. |
...
| [Loosely coupled teams](../../software-development/dora/capability/loosely-coupled-teams.md)| Enable teams to test, deploy, and change systems without dependencies on other teams |
| [Monitoring and Observability](../../software-development/dora/capability/monitoring-and-observability.md)| Learn how to build tooling to help you understand and debug your production systems. |
| [Monitoring systems inform business decisions](../../software-development/dora/capability/monitoring-systems-inform-business-decisions.md)| Improve monitoring across infrastructure platforms, middleware, and the application tier, so you can provide fast feedback to developers. |
...
| [Pervasive security](../../software-development/dora/capability/pervasive-security.md)| Build security into the software development lifecycle without compromising delivery speed. |
| [Proactive failure notification](../../software-development/dora/capability/proactive-failure-notification.md)| Set proactive failure notifications to identify critical issues and act on problems before they arise. |
...
| [Streamlining change approval](../../software-development/dora/capability/streamlining-change-approval.md)| Replace heavyweight change-approval processes with peer review, to get the benefits of a more reliable, compliant release process without sacrificing speed. |
| [Team experimentation](../../software-development/dora/capability/team-experimentation.md)| Innovate faster by building empowered teams that can try out new ideas without approval from people outside the team. |
| [Test automation](../../software-development/dora/capability/test-automation.md)| Improve software quality by building reliable automated test suites and performing all kinds of testing throughout the software delivery lifecycle. |
| [Test data management](../../software-development/dora/capability/test-data-management.md)| Understand the right strategies for managing test data effectively along with approaches to provide fast, secure data access for testing. |
...
| [Transformational leadership](../../software-development/dora/capability/transformational-leadership.md)| Learn how effective leaders influence software delivery performance by driving the adoption of technical and product management capabilities. |
| [Trunk based development](../../software-development/dora/capability/trunk-based-development.md)| Prevent merge-conflict hassles with trunk-based development practices. |
| [Version Control](../../software-development/dora/capability/version-control.md)| A guide to implementing the right version control practices for reproducibility and traceability. |
| [Visibility of work in the value stream](../../software-development/dora/capability/visibility-of-work-in-the-value-stream.md)| Understand and visualize the flow of work from idea to customer outcome in order to drive higher performance. |
| [Visual management](../../software-development/dora/capability/visual-management.md)| Learn about the principles of visual management to promote information sharing, get a common understanding of where the team is, and how to improve. |
| [Well being](../../software-development/dora/capability/well-being.md)| A focus on employee happiness and work environment can improve organizational performance while helping retain talent. |
| [Work in process limits](../../software-development/dora/capability/work-in-process-limits.md)| Prioritize work, limit the amount of things that people are working on, and focus on getting a small number of high-priority tasks done. |
| [Working in small batches](../../software-development/dora/capability/working-in-small-batches.md)| Create shorter lead times and faster feedback loops by working in small batches. Learn common obstacles to this critical capability and how to overcome them. |
